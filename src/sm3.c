...
void sm3_update(sm3_context *ctx, unsigned char *input, int ilen)
{
    ...
    left = ctx->total[0] & 0x3F; //���жϵ�ǰctx���Ѵ��������Ϣ���ֽڳ���ģ64��ʣ����ֽ�����������һ��SM3_update���������ֽ���ģ64��Ĳ����ֽ���
    fill = 64 - left;            //fillΪ����64�ֽ���Ҫ�ڲ����ֽڻ������ٲ�����ֽ���
    ctx->total[0] += ilen;       //���µ�ǰSM3_update������������ֽ���
    ctx->total[0] &= 0xFFFFFFFF;

    if (ctx->total[0] < (unsigned int)ilen) //���������ʱҪ��λ
        ctx->total[1]++;
    /*byte completement to 64 bytes*/
    if (left && ilen >= fill) //���ȣ�������Ҫ������ϴ�SM3_update��������buffer������е�һ���Ĵ���
    {
    ...
    while (ilen >= 64) //��Σ�����input������������64�ֽڣ�512-bit����������Ӧ��������
    {
    ...
    if (ilen > 0) //��󣬽� input�������е�ʣ�����ݿ����� buffer�й���һ�ε���SM3_updateʱʹ�û� SM3_finish�������Ĵ���
    {
...
void sm3_finish(sm3_context *ctx, unsigned char output[32])
{
    ...
    unsigned char msglen[8]; //��8���ֽ�����������һ���е�64���س�����Ϣ

    /*use << 3 because of using binary expression*/
    high = (ctx->total[0] >> 29) | (ctx->total[1] << 3);
    low = (ctx->total[0] << 3); //��total���ֽڳ�����Ϣת��Ϊbit������Ϣ��ע�⵽total[1]�Ǹ�λ����total[0]�ǵ�λ

    PUT_ULONG_BE(high, msglen, 0);
    PUT_ULONG_BE(low, msglen, 4);

    //���һ�������߼��� ����  ��10..0 + 64-bit�ĳ�����䡱��Ӧ�����ֽ���,padn��ʾ"10..0"���ֶ�Ӧ���ֽ���

    last = ctx->total[0] & 0x3F; //lastע������total[1]�Ǹ�λ��total[0]%64 ��ʾ��λ��ʾ���һ���ֿ��ڵ�������Ϣ�����ֽڳ���
 ...
 * for its no usage in our sm2 synergism algorithm, just hide it in reference
 */
